...
mysql = MySQL()
app.config['MYSQL_DATABASE_HOST'] = 'josedavila2745.mysql.pythonanywhere-services.com'
app.config['MYSQL_DATABASE_USER'] = 'josedavila2745'
app.config['MYSQL_DATABASE_PASSWORD'] = 'gruas1803'
app.config['MYSQL_DATABASE_DB'] = 'josedavila2745$gruas'
mysql.init_app(app)
